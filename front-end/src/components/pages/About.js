    ...
    render(){
        return(
            ...
            <div className="item-container">
                <img id="logo" src="/images/shopping-cart.png" alt=""/>
                <p> 
                ...
                <p>
                    Special thanks to DigitalCrafts for their hard work and expertise in helping me transition into the web development realm. I would expecially like to thank the instructor and software architect, Robert Bunch, the Developers in residence: Kyle Booth, Ian Gornall, and Stanley Chen. Without their experience and expertise, I would not have been able to serve up this kind of content. Zac Crosby, JR Priestman, Jason Benson, Katie Duane, Matthew Havins, and Robert Ragans also were great resources of knowledge and help. 
                </p>
